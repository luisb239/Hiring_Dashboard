...
module.exports = (db) => {
    ...
    const db_user = db.entities.user;
    ...
    // TODO
    // Should we update all columns even though some values might be the same?
    // Or should we only update the columns that truly changed => How?
